...
func (in *AddressTranslation) DeepCopyInto(out *AddressTranslation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddressTranslation.
func (in *AddressTranslation) DeepCopy() *AddressTranslation {
	if in == nil {
		return nil
	}
	out := new(AddressTranslation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DRClusterConfigStatus) DeepCopyInto(out *DRClusterConfigStatus) {
	*out = *in
	...
	if in.StorageAccessDetails != nil {
		in, out := &in.StorageAccessDetails, &out.StorageAccessDetails
		*out = make([]StorageAccessDetail, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DRPolicySpec) DeepCopyInto(out *DRPolicySpec) {
	*out = *in
	...
	if in.NetworkMappingRef != nil {
		in, out := &in.NetworkMappingRef, &out.NetworkMappingRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiscoveredNetwork) DeepCopyInto(out *DiscoveredNetwork) {
	*out = *in
	if in.Addresses != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiscoveredNetwork.
func (in *DiscoveredNetwork) DeepCopy() *DiscoveredNetwork {
	if in == nil {
		return nil
	}
	out := new(DiscoveredNetwork)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DiscoveredResource) DeepCopyInto(out *DiscoveredResource) {
	*out = *in
	...
	if in.Networks != nil {
		...
		*out = make([]DiscoveredNetwork, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPTranslationSpec) DeepCopyInto(out *IPTranslationSpec) {
	*out = *in
	out.ResourceRef = in.ResourceRef
	if in.Networks != nil {
		in, out := &in.Networks, &out.Networks
		*out = make([]NetworkTranslation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPTranslationSpec.
func (in *IPTranslationSpec) DeepCopy() *IPTranslationSpec {
	if in == nil {
		return nil
	}
	out := new(IPTranslationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkPeer) DeepCopyInto(out *NetworkPeer) {
	*out = *in
	if in.ClusterCNITypes != nil {
		in, out := &in.ClusterCNITypes, &out.ClusterCNITypes
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkTranslation) DeepCopyInto(out *NetworkTranslation) {
	*out = *in
	if in.Addresses != nil {
		in, out := &in.Addresses, &out.Addresses
		*out = make([]AddressTranslation, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkTranslation.
func (in *NetworkTranslation) DeepCopy() *NetworkTranslation {
	if in == nil {
		return nil
	}
	out := new(NetworkTranslation)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticIPDiscoveryStatus) DeepCopyInto(out *StaticIPDiscoveryStatus) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticIPDiscoveryStatus.
func (in *StaticIPDiscoveryStatus) DeepCopy() *StaticIPDiscoveryStatus {
	if in == nil {
		return nil
	}
	out := new(StaticIPDiscoveryStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticIPTranslationSpec) DeepCopyInto(out *StaticIPTranslationSpec) {
	*out = *in
	if in.IPTranslations != nil {
		in, out := &in.IPTranslations, &out.IPTranslations
		*out = make([]IPTranslationSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticIPTranslationSpec.
func (in *StaticIPTranslationSpec) DeepCopy() *StaticIPTranslationSpec {
	if in == nil {
		return nil
	}
	out := new(StaticIPTranslationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StorageAccessDetail) DeepCopy() *StorageAccessDetail {
	if in == nil {
		return nil
	}
	out := new(StorageAccessDetail)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VRGResourceMeta) DeepCopyInto(out *VRGResourceMeta) {
	*out = *in
	...
	if in.ProtectedStaticIPVMs != nil {
		in, out := &in.ProtectedStaticIPVMs, &out.ProtectedStaticIPVMs
		*out = make([]DiscoveredResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *VolumeReplicationGroupSpec) DeepCopyInto(out *VolumeReplicationGroupSpec) {
	*out = *in
	...
	if in.StaticIPTranslationSpec != nil {
		in, out := &in.StaticIPTranslationSpec, &out.StaticIPTranslationSpec
		*out = new(StaticIPTranslationSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *VolumeReplicationGroupStatus) DeepCopyInto(out *VolumeReplicationGroupStatus) {
	*out = *in
	...
	if in.StaticIPDiscoveryStatus != nil {
		in, out := &in.StaticIPDiscoveryStatus, &out.StaticIPDiscoveryStatus
		*out = new(StaticIPDiscoveryStatus)
		(*in).DeepCopyInto(*out)
	}
}
